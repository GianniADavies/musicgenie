...
from music_app.views import LandingPageView,ArtistCreateView,ArtistListView,ArtistUpdateView,deleteArtist,ArtistUpdateView,SongCreateView,SongListView,SongUpdateView, deleteSong
